...
public class Principal {
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("Qual o preço da gasolina por litro? ");
        double precoGasolina = scanner.nextDouble();

        double custoEncherTanque = Carro.calcularCustoEncherTanque(precoGasolina);
        System.out.println("Custo total para encher o tanque: R$ " + custoEncherTanque);
            ...
            if (ligar.equals("s")) {
                ...
                if (acelerar.equals("s")) {
                    ...
                    while (car.getVelocidade() > 0) {
                        ...
                        System.out.println("3- Adicionar gasolina");
                        ...
                        switch (opcao) {
                            ...
                            case 3:
                                car.adicionarGasolina(gasolina);
                                System.out.println("Adicionou " + gasolina + " litros de gasolina.");
                                break;
